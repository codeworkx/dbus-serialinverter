...
class Dummy(Inverter):
    ...
    def read_status_data(self):
        # Energy data       
        self.energy_data["L1"]['ac_voltage'] = 230
        self.energy_data["L1"]['ac_current'] = 0.0
        self.energy_data["L1"]['ac_power'] = 0.0
        self.energy_data["L1"]['energy_forwarded'] = 0.1

        self.energy_data["L2"]['ac_voltage'] = 0
        self.energy_data["L2"]['ac_current'] = 0
        self.energy_data["L2"]['ac_power'] = 0
        self.energy_data["L2"]['energy_forwarded'] = 0
            
        self.energy_data["L3"]['ac_voltage'] = 0
        self.energy_data["L3"]['ac_current'] = 0
        self.energy_data["L3"]['ac_power'] = 0
        self.energy_data["L3"]['energy_forwarded'] = 0

        self.energy_data['overall']['ac_voltage'] = 0
        self.energy_data['overall']['ac_current'] = 0.0
        self.energy_data['overall']['ac_power'] = 0.0
